...
class _CreateOrgStep2State extends State<CreateOrgStep2> {
  ...
  final Map<String, List<Map<String, String>>> _allPermissions = {
    ...
    'Nodes & Channels': [
      {'key': 'nodes.main.create', 'label': 'Create Main Nodes'},
      {'key': 'nodes.sub.create', 'label': 'Create Sub Nodes / Channels'},
      {'key': 'nodes.name.edit', 'label': 'Edit Node Name'},
      {'key': 'nodes.delete', 'label': 'Delete Node or Channel'},
      {'key': 'nodes.members.remove', 'label': 'Remove Member from Channel'},
      {'key': 'nodes.join.request', 'label': 'Request to Join'},
      {'key': 'nodes.join.auto', 'label': 'Join Without Request'},
      {'key': 'nodes.join.accept', 'label': 'Accept Join Requests'},
    ],
    'Hierarchical Reports': [
      {'key': 'reports.node.view', 'label': 'View Node'},
      {'key': 'reports.send', 'label': 'Send Report'},
      {'key': 'reports.ask', 'label': 'Ask for Report'},
    ],
  };
